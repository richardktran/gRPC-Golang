...
func (c *calculatorServiceClient) PrimeNumberDecomposition(ctx context.Context, in *PNRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompositionClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &calculatorServicePrimeNumberDecompositionClient{ClientStream: stream}
...
func (x *calculatorServicePrimeNumberDecompositionClient) Recv() (*PNResponse, error) {
	m := new(PNResponse)
...
func _CalculatorService_PrimeNumberDecomposition_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CalculatorServiceServer).PrimeNumberDecomposition(m, &calculatorServicePrimeNumberDecompositionServer{ServerStream: stream})
}
...
func (x *calculatorServicePrimeNumberDecompositionServer) Send(m *PNResponse) error {
